<template>
    <!-- The "hidden-xs" class hides the componet in mobile devices -->
    <div class="col s12">
        <div class="carousel-fixed-item flex-div">
            ...
            <div class="home-social-links">
                <a
                    href="https:/instagram.com/thefmngroup"
                    target="_blank"
                    rel="noopener"
                >
                    <img
                ...
                <a
                    href="https:/facebook.com/FMNGroup"
                    target="_blank"
                    rel="noopener"
                >
                    <img
        ...
        <video autolplay muted preload loop id="vid-bg" class="">
            <source
                src="https://flourmills.s3.eu-central-1.amazonaws.com/videos/fmn-video.mp4"
                type="video/mp4"
            />
            <!-- <source src="https://flourmills.s3.eu-central-1.amazonaws.com/FMN+PFI+Video_Without+Livestreaming.mp4" type="video/mp4"> -->
            Your browser does not support the video tag.
        </video>
        <div id="vid-details">
            <!-- <button class="btn btn-floating pry-bg waves-effect" id="vid-play" @click="bgVideoControl">
        <i class="material-icons"  id="vid-play-i">play_arrow</i>
      </button> -->
            <h4 class="bold-txt">
                <span class="pry-bg">
                    <span class="rel">60 years</span>
                </span>
                <br />
                <span class="black-bg">
                    <span class="rel">Of Feeding the Nation,</span>
                </span>
                <br />
                <span class="sec-bg">
                    <span class="rel">Everyday</span>
                </span>
            </h4>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        bgVideoControl() {
            ...
            // var btn_i = document.getElementById("vid-play-i");
            if (video.paused) {
                video.play();
                // btn_i.innerHTML = "pause";
            } else {
                video.pause();
                // btn_i.innerHTML = "play_arrow";
            }
...
#vid-details h4 > span.pry-bg::before {
    background: var(--pry-color);
}
#vid-details h4 > span.pry-bg {
    color: var(--sec-color);
}
#vid-details h4 > span.sec-bg::before {
    background: var(--sec-color);
}
#vid-details h4 > span.sec-bg {
    color: var(--pry-color);
}
#vid-details h4 > span.black-bg::before {
    background: black;
}
#vid-details h4 > span.black-bg {
    color: white;
}
#vid-details button.btn {
    background: var(--pry-color);
    position: relative;
    top: 16px;
    width: 50px;
